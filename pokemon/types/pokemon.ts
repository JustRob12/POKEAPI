...
export const STARTERS: Pokemon[] = [
  ...
  // Gen 2 Starters
  {
    ...
    name: "Chikorita",
    type: "Grass",
    stats: { hp: 45, attack: 49, defense: 65 }
  },
  {
    id: 155,
    name: "Cyndaquil",
  ...
  },
  {
    ...
    name: "Totodile",
    type: "Water",
    stats: { hp: 50, attack: 65, defense: 64 }
  },
  ...
  // Gen 6 Starters (Original)
  {
    id: 650,
    name: 'Chespin',
    type: 'Grass',
    stats: { hp: 56, attack: 61, defense: 65 }
  },
  {
    id: 653,
    name: 'Fennekin',
  ...
  },
  {
    ...
    name: 'Froakie',
    type: 'Water',
    stats: { hp: 41, attack: 56, defense: 40 }
  }
]; 